...
describe('TILItemToken', () => {
  ...
  it.each([
    '* 클린코드 책 100-240페이지 읽기',
    '- Learn about Vue3 composition API',
    '- Search about AWS Cloud Computing',
  ])('다른 마커 모양을 파싱하지 않는지 (%p)', (input) => {
    const token = TILItemToken.tryParse(input, 0);
  ...
  it.each([
    ...
    [
      [
        '1. OAuth Flow 종류에 대해 공부',
        '• Authorization Code Grant',
        '• Implicit Grant',
        '• Resource Owner Client Grant',
  ...
  it.each([
    ...
    [['1. 캡스톤 프로젝트 README.md 작성', '2. 기말고사 준비'], '캡스톤 프로젝트 README.md 작성'],
